            ...
            for smali_file in util.show_list_progress(
                ...
                for line_number, line in enumerate(lines):
                    ...
                    if static_string_match and static_string_match.group(
                        "string_value") and \
                            static_string_match.group("string_value") in \
                            obfuscation_info.string_to_encrypt:
                    ...
                    if string_match and string_match.group("string") and \
                        string_match.group("string") in \
                            obfuscation_info.string_to_encrypt:
